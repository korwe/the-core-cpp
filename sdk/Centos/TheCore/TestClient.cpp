...
int main (int argc, char const *argv[])
{
    ...
    InitiateSessionResponse* response = dynamic_cast<InitiateSessionResponse*>(receiver.getNextCoreMessage(500));
    if (response == 0) {
    ...
    KillSessionResponse* killResponse = dynamic_cast<KillSessionResponse*>(receiver.getNextCoreMessage(15000));
    if (killResponse == 0) {
